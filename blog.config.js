...
const BLOG = {
  AUTHOR: '线材定制专家', // 作者
  BIO: '微信扫描上方二维码联系我', // 作者简介
  LINK: 'https://cable.hk.cn', // 网站地址
  KEYWORDS: 'cable, 博客', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || '69cfc0fc8cd34460a143fc141ce18e88', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '', // 备案号 粤ICP备XXXXXXX
